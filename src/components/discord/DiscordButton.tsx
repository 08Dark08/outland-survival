...
export function DiscordButton({
  ...
  const base =
    "group inline-flex items-center justify-center gap-2.5 font-mono uppercase font-semibold text-xs tracking-wider transition-all duration-300 select-none";
